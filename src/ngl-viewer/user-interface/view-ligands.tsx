...
const ViewLigands = <T,>() => {
  ...
  const [ligandsParams, setLigandsParams] = React.useState<
  ...
  useEffect(() => {
    ...
    if (!comp) return;
    setComponent(comp);
    const ligandComponents = stage?.compList.slice(
      1
  ...
  const updateInteractionParameter = (
  ...
  const showLigandWithProtein = () => {
    ...
    let concatStructures = ligandComps.map((ligandComp) => {
    ...
    let concatComp = stage?.addComponentFromObject(
      newObj
    ) as NGL.StructureComponent;
    ...
    ligandComps.forEach((ligandComp, index) => {
      let pocketRadius = 5;
      let withinPocketSele = concatComp.structure.getAtomSetWithinSelection(
        new NGL.Selection(`/${index + 1}`),
        pocketRadius + 2
      );
      let pocketSele = `(${withinPocketSele.toSeleString()}) and not (${
        index + 1
      }) and polymer)`;

      // get all the atoms within 5 angstroms of the ligand together with the ligand
      let withinSele = concatComp.structure.getAtomSetWithinSelection(
        new NGL.Selection(`/${index + 1}`),
        5
      );
      ...
      ligandComps.forEach((ligandComp2, index2) => {
        ...
        let onlySele = concatComp.structure.getAtomSetWithinSelection(
          new NGL.Selection(`/${index2 + 1}`),
          0
        );
  ...
  return (
    <div>
      ...
      <div>
        <span>pocket radius clipping</span>
        <input
          type="range"
          value={radius}
          min={0}
      ...
      <div>
        <span>pocket near clipping</span>
        <input
          type="range"
          value={near}
          min={0}
      ...
      <div>
        ...
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["hydrophobic"], e)
          }
        />
      </div>
      <div>
        ...
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["hydrogen bond"], e)
          }
        />
      </div>
      <div>
        <span>weak hbond</span>
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["weak hbond"], e)
          }
        />
      </div>
      <div>
        <span>backbone-backbone hbond</span>
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(
              interactions["backbone-backbone hbond"],
              e
            )
          }
        />
      ...
      <div>
        <span>halogen bond</span>
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["halogen bond"], e)
          }
        />
      </div>
      <div>
        ...
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["metal interaction"], e)
          }
        />
      </div>
      <div>
        ...
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["salt bridge"], e)
          }
        />
      </div>
      <div>
        ...
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["cation-pi"], e)
          }
        />
      </div>
      <div>
        <span>pi-stacking</span>
        <input
          type="checkbox"
          onChange={(e) =>
            updateInteractionParameter(interactions["pi-stacking"], e)
          }
        />
      </div>
      <div>
        ...
        {Object.values(ligandsParams).map((ligandParam) => {
          return (
            <div key={ligandParam.name}>
              ...
              <input
                type="checkbox"
                checked={ligandParam.visibility}
                onChange={(e) => toggleLigand(e, ligandParam)}
              />
            </div>
          );
        })}
      ...
      <div>
        <div>
          ...
          <input
            type="checkbox"
            onChange={(e) => proteinReprChange(e, "backbone")}
          />
        </div>
        <div>
          <label>cartoon</label>
          <input
            type="checkbox"
            onChange={(e) => proteinReprChange(e, "cartoon")}
          />
        </div>
        <div>
          <label>surface</label>
          <input
            type="checkbox"
            onChange={(e) => proteinReprChange(e, "surface", "polymer")}
          />
        </div>
      </div>
    </div>
