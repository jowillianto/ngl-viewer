...
import NGLScreenshot, { ImageParameters, NGLScreenshotP } from "../utils/screenshot"
...
export const ScreenshotDownload = <T,>(
  {render, props, onClick} : ScreenshotDownloadT<T>
) => {
...
const ScreenshotAndDownload = <T, >(
  props : ScreenshotAndDownloadT<T>
) => {
  return (
    <NGLScreenshot 
