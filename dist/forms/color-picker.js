...
export var ColorPicker = function (_a) {
    ...
    return (_jsxs("div", { children: [_jsx("label", { htmlFor: "colorPicker", children: "Color Picker" }), _jsx("input", { type: "color", id: "colorPicker", value: color, onChange: handleColorChange })] }));
};
