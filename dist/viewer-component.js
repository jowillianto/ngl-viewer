...
var ViewerComponent = function () {
    ...
    return (_jsx("div", __assign({ className: "viewer ".concat(theme, "-theme") }, { children: _jsx("div", __assign({ className: "navbar" }, { children: _jsxs("div", __assign({ className: "container" }, { children: [_jsx("div", __assign({ className: "navbar-brand" }, { children: "CaliciNGL" })), _jsx("div", __assign({ className: "navbar-collapse" }, { children: _jsxs("ul", __assign({ className: "navbar-nav" }, { children: [_jsxs("li", { children: [_jsx("input", { type: "file", ref: fileInputRef, onChange: handleFileSelect, style: { display: 'none' } }), _jsx("button", __assign({ onClick: function () { var _a; return (_a = fileInputRef.current) === null || _a === void 0 ? void 0 : _a.click(); } }, { children: "Open" }))] }), _jsx("li", { children: _jsx(ScreenshotAndDownload, { render: function (props) { return _jsx("button", __assign({}, props, { children: "Screenshot" })); }, props: {} }) }), _jsx("li", { children: _jsx(ThemeSwitcher, { render: function (props) { return (_jsx("button", __assign({ onClick: props.onClick }, { children: props.currentTheme === "light" ? "Light" : "Dark" }))); }, props: {} }) }), _jsx("li", { children: _jsx(ToggleRockSpinOrOff, { initialState: "spin", render: function (props) { return (_jsx("button", __assign({}, props, { children: "toggle spin" }))); }, props: {} }) }), _jsx("li", { children: _jsx(ToggleRockSpinOrOff, { initialState: "rock", render: function (props) { return (_jsx("button", __assign({}, props, { children: "toggle rock" }))); }, props: {} }) }), _jsx("li", { children: _jsx(SetCameraType, { render: ViewSelect, props: {
                                            options: [{
                                                    label: "Perspective",
                                                    value: "perspective"
                                                }, {
