...
export default function NGLCylinder(_a) {
    ...
    var shapeCreator = React.useMemo(function () {
        return new NGL.Shape(undefined, shapeParams).addCylinder(position1, position2, color, radius, name === undefined ? randomString(10) : name);
