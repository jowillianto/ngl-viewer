...
var NGLEllipsoid = /** @class */ (function (_super) {
    __extends(NGLEllipsoid, _super);
    function NGLEllipsoid(props) {
        var _this = _super.call(this, props) || this;
        _this.addEllipsoid = function (shape) {
            ...
            return shape.addEllipsoid(position, color, radius, majorAxis, minorAxis, name);
        };
        _this.randomName = randomString(10);
        return _this;
    }
    NGLEllipsoid.prototype.hashProps = function () {
