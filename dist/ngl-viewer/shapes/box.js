...
export default function NGLBox(_a) {
    ...
    var shapeCreator = React.useMemo(function () {
        return new NGL.Shape(undefined, shapeParams).addBox(position, color, size, heightAxis, depthAxis, name === undefined ? randomString(10) : name);
