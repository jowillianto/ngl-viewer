...
var Collapsible = function (_a) {
    ...
    return (_jsxs("div", { className: "collapsible", children: [_jsxs("div", { className: "collapsible-header", children: [_jsxs("div", { className: 'title', children: [_jsx("span", { className: "toggle-icon", onClick: toggleCollapsible, children: isOpen ? _jsx(FontAwesomeIcon, { icon: faSquareMinus }) : _jsx(FontAwesomeIcon, { icon: faSquarePlus }) }), _jsx("span", { children: fileName })] }), _jsxs("div", { className: "actions", children: [_jsx("span", { onClick: changeViewOfComponent, children: showAllRepresentations ? _jsx(FontAwesomeIcon, { icon: faEye }) : _jsx(FontAwesomeIcon, { icon: faEyeSlash }) }), _jsx("span", { onClick: centerStructure, children: _jsx(FontAwesomeIcon, { icon: faCircleDot }) }), _jsx("span", { onClick: deleteComponent, children: _jsx(FontAwesomeIcon, { icon: faTrash }) })] })] }), isOpen &&
                _jsx("div", { className: "collapsible-content", children: representation.map(function (item) {
                        return (_jsxs("div", { className: "collapsible-header", children: [_jsx("div", { className: 'title', children: item }), _jsxs("div", { className: "actions", children: [_jsx("span", { onClick: function () { return changeViewSetting(item); }, children: typeList.includes(item) ? _jsx(FontAwesomeIcon, { icon: faEye }) : _jsx(FontAwesomeIcon, { icon: faEyeSlash }) }), _jsx("span", { onClick: function () { return deleteRepresentation(item); }, children: item === lastClickedItem ? _jsx(FontAwesomeIcon, { icon: faTrash, fade: true }) : _jsx(FontAwesomeIcon, { icon: faTrash }) })] })] }));
                    }) })] }));
};
